      ...
      lang: {
        zh: {
          ...
          content: '<p>\n' +
            ...
            '\n' +
            '      <h3>8.版权保护及责任</h3>\n' +
            '      <p>1. 本软件展示和生成的内容在未经允许的情况下不可用于任何商业行为；</p>\n' +
            '      <p>2. 禁止用于合成(辅助)传播各类淫秽、低俗、毒品、赌博等违法犯罪等相关内容；</p>\n' +
            '      <p>3. 任何违规和违法行为造成的后果和责任由使用者承担。</p>\n' +
            '\n' +
            '      <h3>主体信息</h3>\n' +
            '      <ul>\n' +
        ...
        en: {
          ...
          content: '<p>\n' +
            ...
            '      <p>1. The content displayed and generated by the software shall not be used for any commercial activities without permission;</p>\n' +
            '      <p>2. It is prohibited to synthesize (assist) the dissemination of all kinds of obscene, vulgar, drug, gambling and other illegal and criminal content;</p>\n' +
            '      <p>3. The consequences and responsibilities caused by any violation or illegal act shall be borne by the user.</p>\n' +
            '\n' +
            '      <h3>Subject</h3>\n' +
            '      <ul>\n' +
